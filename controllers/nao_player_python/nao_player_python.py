"""Python controller for Nao robot for robocup player."""
...
class Nao (Robot):
    ...
    # the accelerometer axes are oriented same as on the real nao robot
    ...
    def printHelp(self):
        ...
        print('[K]: Shoot/Kick Football')
        print('[Y]: Get up from Front')
